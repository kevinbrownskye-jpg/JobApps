...
def clean_build_artifacts(base_dir: str) -> None:
    ...
    # Debug runtime hook (only created when --debug-app is used)
...
def build(onefile: bool, debug: bool, base_dir: str, debug_app: bool = False) -> None:
    ...
    # Bake PYWEBVIEW_DEBUG=1 into the .exe environment if --debug-app was requested
    if debug_app:
        # PyInstaller runtime hook: set env var before app code runs
